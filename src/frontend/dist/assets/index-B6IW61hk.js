...
class BassEngine {
  constructor() {
    ...
    __publicField(this, "bassEngineInputGain");
    // 4GA-BASS-IN
    __publicField(this, "bassEngineOutputGain");
    // 4GA-BASS-OUT
    // Bass processing nodes
    __publicField(this, "bassFilter");
    __publicField(this, "bassEpicenter");
    __publicField(this, "bassCheaterBeater");
    __publicField(this, "bassEQuake");
    __publicField(this, "bassExcursionFilter");
    __publicField(this, "bassExcursionGain");
    __publicField(this, "bassNaturalBottom");
    __publicField(this, "bassSoulResonance");
    __publicField(this, "multiFreq20");
    __publicField(this, "multiFreq32");
    __publicField(this, "multiFreq40");
    __publicField(this, "multiFreq50");
    __publicField(this, "bassGainNode");
    __publicField(this, "smartChips");
    // Virtual Magnet — LFO modulation only (bass only, never highs/mids)
    __publicField(this, "virtualMagnetOsc");
    __publicField(this, "virtualMagnetDepthGain");
    __publicField(this, "ctx");
  }
  init(ctx) {
    this.ctx = ctx;
    this.bassEngineInputGain = ctx.createGain();
    this.bassEngineInputGain.gain.value = 1;
    this.bassFilter = ctx.createBiquadFilter();
    this.bassFilter.type = "lowpass";
    this.bassFilter.frequency.value = 50;
    this.bassFilter.Q.value = 0.7;
    this.bassEpicenter = this._makePeaking(ctx, 32, 2, 0);
    this.bassCheaterBeater = this._makePeaking(ctx, 33, 3, 0);
    this.bassEQuake = ctx.createGain();
    this.bassEQuake.gain.value = 0;
    this.bassExcursionFilter = this._makePeaking(ctx, 80, 2, 0);
    this.bassExcursionGain = ctx.createGain();
    this.bassExcursionGain.gain.value = 0;
    ...
    this.bassSoulResonance = this._makePeaking(ctx, 300, 2, 0);
    this.multiFreq20 = this._makePeaking(ctx, 20, 2, 0);
    this.multiFreq32 = this._makePeaking(ctx, 32, 2, 0);
    this.multiFreq40 = this._makePeaking(ctx, 40, 2, 0);
    this.multiFreq50 = this._makePeaking(ctx, 50, 2, 0);
    this.bassGainNode = ctx.createGain();
    this.bassGainNode.gain.value = 0;
    this.smartChips = [];
    for (let i = 0; i < 20; i++) {
      const freq = 20 + i / 19 * 80;
      this.smartChips.push(this._makePeaking(ctx, freq, 2, 0));
    }
    ...
    this.bassEngineOutputGain.gain.value = 1;
  ...
  getStatus() {
    var _a2;
    const g = ((_a2 = this.bassGainNode) == null ? void 0 : _a2.gain.value) ?? 0;
    if (!this.bassFilter) {
      return {
        name: "Bass Engine",
        engine: "bass",
  ...
  runDiagnostic() {
    const results = [];
    const check = (node, pass, dir, detail) => ({
      node,
      engine: "bass",
    ...
    results.push(
      check(
        "bassEngineInputGain",
        this.bassEngineInputGain !== void 0,
        "backward",
  ...
  _makePeaking(ctx, freq, q, gainDb) {
...
class HighsEngine {
  constructor() {
    __publicField(this, "highsEngineInputGain");
    // 4GA-HIGHS-IN
    __publicField(this, "highsEngineOutputGain");
    // 4GA-HIGHS-OUT
    __publicField(this, "highsFilter");
    __publicField(this, "highsPresence");
    __publicField(this, "highsGainNode");
    __publicField(this, "tweetersFilter");
    __publicField(this, "tweetersGainNode");
    // Separate output for tweeters channel
    __publicField(this, "tweetersEngineOutputGain");
  }
  // 4GA-TWEETERS-OUT
  init(ctx) {
    this.highsEngineInputGain = ctx.createGain();
    this.highsEngineInputGain.gain.value = 1;
    this.highsFilter = ctx.createBiquadFilter();
    this.highsFilter.type = "highpass";
    this.highsFilter.frequency.value = 4e3;
    this.highsFilter.Q.value = 0.7;
    this.highsPresence = ctx.createBiquadFilter();
    this.highsPresence.type = "highshelf";
    this.highsPresence.frequency.value = 8e3;
    this.highsPresence.gain.value = 2;
    this.highsGainNode = ctx.createGain();
    this.highsGainNode.gain.value = 1;
    this.highsEngineOutputGain = ctx.createGain();
    this.highsEngineOutputGain.gain.value = 1;
    this.tweetersFilter = ctx.createBiquadFilter();
    this.tweetersFilter.type = "highpass";
    this.tweetersFilter.frequency.value = 8e3;
    this.tweetersFilter.Q.value = 0.7;
    this.tweetersGainNode = ctx.createGain();
    this.tweetersGainNode.gain.value = 1;
    this.tweetersEngineOutputGain = ctx.createGain();
    this.tweetersEngineOutputGain.gain.value = 1;
  ...
  getStatus() {
    var _a2, _b2;
    const hg = ((_a2 = this.highsGainNode) == null ? void 0 : _a2.gain.value) ?? 0;
    const tg = ((_b2 = this.tweetersGainNode) == null ? void 0 : _b2.gain.value) ?? 0;
    if (!this.highsFilter) {
      return {
        name: "Highs Engine",
        engine: "highs",
  ...
  runDiagnostic() {
    ...
    results.push(
      check(
        "highsEngineInputGain",
        this.highsEngineInputGain !== void 0,
        "backward",
        "entry wire confirmed"
      )
    );
...
class MidsEngine {
  constructor() {
    __publicField(this, "midsEngineInputGain");
    // 4GA-MIDS-IN
    __publicField(this, "midsEngineOutputGain");
    // 4GA-MIDS-OUT
    __publicField(this, "midsFilter");
    __publicField(this, "midsSoulMode");
    __publicField(this, "midsGainNode");
  }
  init(ctx) {
    this.midsEngineInputGain = ctx.createGain();
    this.midsEngineInputGain.gain.value = 1;
    this.midsFilter = ctx.createBiquadFilter();
    this.midsFilter.type = "bandpass";
    this.midsFilter.frequency.value = 1e3;
  ...
  getStatus() {
    var _a2;
    const g = ((_a2 = this.midsGainNode) == null ? void 0 : _a2.gain.value) ?? 0;
    if (!this.midsFilter) {
      return {
        name: "Mids Engine",
        engine: "mids",
  ...
  runDiagnostic() {
    ...
    results.push(
      check(
        "midsEngineInputGain",
        this.midsEngineInputGain !== void 0,
        "backward",
        "entry wire confirmed"
      )
    );
...
class SystemEngine {
  constructor() {
    ...
    __publicField(this, "systemEngineInputGain");
    // 4GA-SYS-IN
    __publicField(this, "frontlineVolume");
    __publicField(this, "stabilizerA");
    __publicField(this, "stabilizerB");
    __publicField(this, "stabilizerC");
    __publicField(this, "stabilizerD");
    __publicField(this, "powerConverter");
    __publicField(this, "signalBooster");
    // Post-channel-merge section
    __publicField(this, "systemMergeInputGain");
    // 4GA-SYS-MERGE-IN
    __publicField(this, "xmPowerGain");
    __publicField(this, "xmShelf1");
    __publicField(this, "xmShelf2");
    __publicField(this, "srsNode");
    __publicField(this, "srsWetGain");
    __publicField(this, "srsDryGain");
    __publicField(this, "protectionPower");
    __publicField(this, "protectionGate");
    __publicField(this, "systemBoosterPower");
    __publicField(this, "systemBoosterNode");
    __publicField(this, "masterGainNode");
    __publicField(this, "systemEngineOutputGain");
    // 4GA-SYS-OUT
    // Titanium Fuse — monitoring only
    __publicField(this, "titaniumAnalyser");
  }
  init(ctx) {
    this.ctx = ctx;
    this.systemEngineInputGain = ctx.createGain();
    this.systemEngineInputGain.gain.value = 1;
    this.frontlineVolume = ctx.createGain();
    this.frontlineVolume.gain.value = 0.7;
    this.stabilizerA = ctx.createGain();
    this.stabilizerA.gain.value = 1;
    this.stabilizerB = ctx.createGain();
    this.stabilizerB.gain.value = 1;
    this.stabilizerC = ctx.createGain();
    this.stabilizerC.gain.value = 1;
    this.stabilizerD = ctx.createGain();
    this.stabilizerD.gain.value = 1;
    this.powerConverter = ctx.createGain();
    this.powerConverter.gain.value = 1;
    this.signalBooster = ctx.createGain();
    this.signalBooster.gain.value = 1;
  ...
  getStatus() {
    ...
    const mgOk = ((_a2 = this.masterGainNode) == null ? void 0 : _a2.gain.value) > 0.01;
    if (!ctxRunning) {
      return {
        name: "System Engine",
        engine: "system",
  ...
  runDiagnostic() {
    var _a2, _b2;
    const results = [];
    const check = (node, pass, dir, detail, autoFixed, fixDescription) => ({
      node,
      engine: "system",
      status: pass ? "pass" : "fail",
      direction: dir,
    ...
    const ctxOk = ((_a2 = this.ctx) == null ? void 0 : _a2.state) === "running";
    results.push(
      check(
        "AudioContext",
        ctxOk,
        "forward",
        `state=${((_b2 = this.ctx) == null ? void 0 : _b2.state) ?? "none"}`
      )
    );
    results.push(
      check(
...
const storage = {
  ...
  loadNum(key, defaultValue) {
    try {
      const raw = localStorage.getItem(PREFIX + key);
      if (raw === null) return defaultValue;
      const v2 = Number(JSON.parse(raw));
      return Number.isFinite(v2) ? v2 : defaultValue;
    } catch {
      return defaultValue;
    }
  },
  loadBool(key, defaultValue) {
    try {
      const raw = localStorage.getItem(PREFIX + key);
      if (raw === null) return defaultValue;
...
class PowerAmpEngine {
  constructor() {
    ...
    __publicField(this, "_trackName", "");
    // ---- core ----
    __publicField(this, "ctx");
    __publicField(this, "audioEl");
    __publicField(this, "sourceNode");
    // ---- 4 engines ----
    __publicField(this, "bassEngine", new BassEngine());
    __publicField(this, "midsEngine", new MidsEngine());
    __publicField(this, "highsEngine", new HighsEngine());
    __publicField(this, "systemEngine", new SystemEngine());
    // ---- EQ layer (sits between power chain and channel split) ----
    __publicField(this, "eqBassNode");
    __publicField(this, "eqLowMidNode");
    __publicField(this, "eqVocalsNode");
    __publicField(this, "eqMidNode");
    __publicField(this, "eqHighMidNode");
    __publicField(this, "eqTrebleNode");
    // ---- channel merger (sums 4 engine outputs) ----
    __publicField(this, "channelMerger");
    // ---- additive taps ----
    __publicField(this, "beamLeft");
    __publicField(this, "beamRight");
    __publicField(this, "beamFront");
    __publicField(this, "beamRear");
    __publicField(this, "beamMergeGain");
    __publicField(this, "atmosConvolver");
    __publicField(this, "atmosWetGain");
    // ---- analyser ----
    __publicField(this, "analyserNode");
    __publicField(this, "analyserData");
    __publicField(this, "rafId", 0);
    // ---- AudioContext resume listeners (document-level, never page-level) ----
    __publicField(this, "resumeCtx", () => {
  ...
  _buildChain() {
    ...
    this.eqBassNode = this._makePeaking(ctx, 40, 1, 0);
    this.eqLowMidNode = this._makePeaking(ctx, 250, 1, 0);
    this.eqVocalsNode = this._makePeaking(ctx, 1e3, 1, 0);
    this.eqMidNode = this._makePeaking(ctx, 2e3, 1, 0);
    this.eqHighMidNode = this._makePeaking(ctx, 5e3, 1, 0);
    this.eqTrebleNode = this._makePeaking(ctx, 1e4, 1, 0);
    this.channelMerger = ctx.createGain();
    this.channelMerger.gain.value = 1;
  ...
  setMidsEnabled(enabled) {
    if (!this._initialized) return;
    this._ramp(this.midsEngine.midsGain_.gain, enabled ? 1 : 0);
    storage.save("midsEnabled", enabled);
  }
  setHighsEnabled(enabled) {
    if (!this._initialized) return;
    this._ramp(this.highsEngine.highsGain_.gain, enabled ? 1 : 0);
    storage.save("highsEnabled", enabled);
  }
  setTweetersEnabled(enabled) {
    if (!this._initialized) return;
    this._ramp(this.highsEngine.tweetersGain_.gain, enabled ? 1 : 0);
    storage.save("tweetersEnabled", enabled);
  }
  setEpicenter(enabled, depthDb) {
    if (!this._initialized) return;
    this._ramp(
  ...
  setCheaterBeater(enabled, depthDb) {
    if (!this._initialized) return;
    if (enabled) {
  ...
  setMidBassExcursion(enabled, depthDb) {
    if (!this._initialized) return;
    this._ramp(
      this.bassEngine.bassExcursionGain_.gain,
      enabled ? Math.max(0, Math.min(1, depthDb / 12)) : 0
    );
    this._ramp(
  ...
  setSoundBeaming(enabled, intensityPct) {
    if (!this._initialized) return;
    const intensity = enabled ? Math.max(0, Math.min(0.5, intensityPct / 100 * 0.5)) : 0;
    this._ramp(this.beamMergeGain.gain, intensity);
    storage.save("soundBeamEnabled", enabled);
    storage.save("beamIntensity", intensityPct);
  }
  setVirtualMagnet(enabled, depthPct) {
    if (!this._initialized) return;
    const depth = enabled ? Math.max(0, Math.min(0.2, depthPct / 100 * 0.2)) : 0;
  ...
  setSystemBooster(enabled) {
    if (!this._initialized) return;
    this._ramp(this.systemEngine.systemBoosterNode_.gain, enabled ? 1.38 : 1);
  ...
  runBidirectionalScan() {
    ...
    const forward = [
      ...this.bassEngine.runDiagnostic().filter((r) => r.direction === "forward"),
      ...this.midsEngine.runDiagnostic().filter((r) => r.direction === "forward"),
      ...this.highsEngine.runDiagnostic().filter((r) => r.direction === "forward"),
      ...this.systemEngine.runDiagnostic().filter((r) => r.direction === "forward")
    ];
    const backward = [
      ...this.systemEngine.runDiagnostic().filter((r) => r.direction === "backward"),
      ...this.highsEngine.runDiagnostic().filter((r) => r.direction === "backward"),
      ...this.midsEngine.runDiagnostic().filter((r) => r.direction === "backward"),
      ...this.bassEngine.runDiagnostic().filter((r) => r.direction === "backward")
    ];
    return [...forward, ...backward];
  }
  async runSmartTrackTest() {
    if (!this._initialized) {
      return {
        passed: false,
        results: [
    ...
    if (this.ctx.state !== "running") {
      await this.ctx.resume();
      const fixed = this.ctx.state === "running";
      results.push({
        node: "AudioContext",
        engine: "system",
        ...
        autoFixed: fixed,
        fixDescription: fixed ? "AudioContext resumed" : void 0
      });
    ...
    const measureSignal = (analyser) => {
      const data = new Uint8Array(analyser.frequencyBinCount);
      analyser.getByteFrequencyData(data);
      let sum = 0;
      for (const v2 of data) sum += v2;
    ...
    const forwardChecks = [
      ...
      },
      {
        ...
        isOk: (v2) => v2 > 0.01,
        fix: () => {
          this.midsEngine.midsGain_.gain.value = 1;
        },
      ...
      },
      {
        ...
        isOk: (v2) => v2 > 0.01,
        fix: () => {
          this.highsEngine.highsGain_.gain.value = 1;
        },
      ...
      },
      {
        ...
        isOk: (v2) => v2 > 0.01,
        fix: () => {
          this.highsEngine.tweetersGain_.gain.value = 1;
        },
    ...
    for (const chk of forwardChecks) {
      const v2 = chk.getValue();
      const ok = chk.isOk(v2);
      let autoFixed;
      let fixDescription;
      if (!ok && chk.fix) {
        chk.fix();
    ...
    results.push({
      node: "testSignal",
      engine: "system",
      status: signalLevel > 1e-3 ? "pass" : "warn",
      direction: "forward",
    ...
    const summary = passed ? `✓ All ${results.length} checks passed — chain confirmed ready` : `${results.length - failedCount} passed · ${autoFixedCount} auto-fixed · ${failedCount} issues found`;
  ...
  scan() {
    ...
    return [
      this.ctx.state === "running" ? ok("ctx", "AudioContext State", "RUNNING") : err("ctx", "AudioContext State", `SUSPENDED (${this.ctx.state})`),
      mg > 0.01 ? ok("mg", "Master Gain", `${mg.toFixed(3)} ✓`) : err("mg", "Master Gain", `${mg.toFixed(3)} — ZERO!`),
      fv > 0.01 ? ok("fv", "Frontline Volume", `${fv.toFixed(3)} ✓`) : err("fv", "Frontline Volume", `${fv.toFixed(3)} — ZERO!`),
      basisG > 0 ? ok("bg", "Bass Gain", `${basisG.toFixed(3)}`) : warn("bg", "Bass Gain", "ZERO — bass OFF (user turns up)"),
      midsG > 0.01 ? ok("mids", "Mids Gain", `${midsG.toFixed(3)}`) : err("mids", "Mids Gain", "ZERO — no vocals/mids"),
      highsG > 0.01 ? ok("highs", "Highs Gain", `${highsG.toFixed(3)}`) : err("highs", "Highs Gain", "ZERO — no highs"),
      tweetsG > 0.01 ? ok("tweets", "Tweeters Gain", `${tweetsG.toFixed(3)}`) : err("tweets", "Tweeters Gain", "ZERO — no tweeters"),
      ok(
        "split",
        "Channel Split",
      ...
      this.audioEl.readyState >= 2 ? ok("audio", "Audio Element", `readyState=${this.audioEl.readyState}`) : warn(
        "audio",
        "Audio Element",
  ...
  playStartupTone() {
    ...
    [261.63, 329.63, 392].forEach((freq, i) => {
      ...
      gain.gain.setValueAtTime(0, now2 + i * 0.18);
      gain.gain.linearRampToValueAtTime(0.18, now2 + i * 0.18 + 0.02);
      gain.gain.exponentialRampToValueAtTime(1e-3, now2 + i * 0.18 + 0.35);
      osc.connect(gain);
      gain.connect(this.ctx.destination);
      osc.start(now2 + i * 0.18);
      osc.stop(now2 + i * 0.18 + 0.4);
    });
  }
  getContextState() {
...
const engine = new PowerAmpEngine();
function AmpSlider({
  label,
  value,
  min,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono text-foreground/70 tracking-wider uppercase", children: label }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-mono", style: { color }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "input",
      {
        ...
        value,
        readOnly,
        onChange: readOnly ? void 0 : (e) => onChange(Number(e.target.value)),
...
function AmpToggle({ label, enabled, onToggle, ...rest }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
      ...
      "data-ocid": rest["data-ocid"],
      className: `flex items-center gap-2 px-3 py-2 rounded-lg text-xs font-mono tracking-wider uppercase transition-all ${enabled ? "bg-primary/20 border border-primary/60 text-primary" : "bg-muted/30 border border-border/40 text-foreground/50"}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
        ...
        label,
        ": ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold", children: enabled ? "ON" : "OFF" })
      ]
    }
  );
}
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                ...
                subtitle && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-foreground/50 mt-0.5", children: subtitle })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "gauge-wire active mb-4" }),
...
function AtmosmasherePanel({ onClose }) {
  const [enabled, setEnabled] = reactExports.useState(false);
  const [wet, setWet] = reactExports.useState(40);
  const toggle = (v2) => {
    setEnabled(v2);
    engine.setAtmos(v2, wet);
  };
  const setW = (v2) => {
    setWet(v2);
    engine.setAtmos(enabled, v2);
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    PanelShell,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "smd-meter text-center", children: "SPATIAL 3D · CONVOLVER · ADDITIVE TAP" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          AmpToggle,
          {
            label: "Atmosmashere",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "slot-panel", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs font-mono text-foreground/60", children: [
          "⚡ ADDITIVE TAP: channelMerger → ConvolverNode → atmosWetGain → destination",
          /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
          "Dry signal flows through main chain uninterrupted · Zero cyclic loop risk"
        ] }) })
      ]
    }
  );
}
function AudioBufferPanel({ onClose }) {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-bold mb-2", style: { color: "#00d5ff" }, children: "Virtual Audio Buffer" }),
              "Signal spike absorber and smart buffer that holds the signal until all nodes are ready. Sits between the Frontline Volume and the Stabilizer Commander. Absorbs overload spikes before they reach any amp, prevents pops and crackling during feature transitions, and self-heals if a node goes offline.",
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3 text-foreground/40", children: "Wiring: API · HTML · Chainblock · 4GA Wire" })
            ]
          }
        ),
        !confirmed ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            style: {
              background: "linear-gradient(135deg, rgba(0,100,255,0.2), rgba(255,180,0,0.1))",
              border: "1px solid rgba(255,180,0,0.4)",
              color: "#fbbf24"
            },
            children: "TAP TO ACTIVATE"
          }
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: "Activating this feature wires it into your chain. Press CONFIRM when ready — or CANCEL to keep it locked."
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              children: "CONFIRM WIRE-IN (COMING SOON)"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
...
function BassSwitchPanel({ onClose }) {
  const [confirmed, setConfirmed] = reactExports.useState(false);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    PanelShell,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-bold mb-2", style: { color: "#00d5ff" }, children: "Bass Note Switching" }),
              "Real-time analyzer detects and switches bass frequencies per song automatically. Every bass note triggers the correct frequency profile. Locks 3–4 dominant frequencies per layer and switches in real time as the song plays. Epicenter holds the foundation during every switch.",
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3 text-foreground/40", children: "Wiring: API · HTML · Chainblock · 4GA Wire" })
            ]
          }
        ),
        !confirmed ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          ...
          {
            type: "button",
            "data-ocid": "bass_switch.activate_button",
            onClick: () => setConfirmed(true),
            className: "w-full py-3 rounded-xl font-mono font-bold text-sm uppercase tracking-widest transition-all",
            style: {
              background: "linear-gradient(135deg, rgba(0,100,255,0.2), rgba(255,180,0,0.1))",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            {
              type: "button",
              "data-ocid": "bass_switch.confirm_button",
              disabled: true,
              className: "w-full py-3 rounded-xl font-mono font-bold text-sm uppercase tracking-widest opacity-40 cursor-not-allowed",
              style: {
                background: "rgba(0,50,120,0.3)",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            {
              type: "button",
              "data-ocid": "bass_switch.cancel_button",
              onClick: () => setConfirmed(false),
              className: "w-full py-2 rounded-lg font-mono text-xs uppercase tracking-widest transition-all",
              style: {
                background: "rgba(0,20,50,0.4)",
...
function CachePanel({ onClose }) {
  ...
  const handleClearReload = reactExports.useCallback(() => {
    localStorage.clear();
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: "Clears all saved settings and resets the app to default values. Every slider, toggle, and control will return to its factory position on the next load. Your audio chain is not affected — only saved preferences are cleared."
          }
        ),
        status === "cleared" && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: "✓ Cache cleared. Reload to apply defaults."
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            className: "w-full py-3 rounded-xl font-mono font-bold text-sm uppercase tracking-widest transition-all",
            style: {
              background: status === "cleared" ? "rgba(0,80,40,0.3)" : "linear-gradient(135deg, rgba(200,30,30,0.25), rgba(255,60,60,0.15))",
              border: `1px solid ${status === "cleared" ? "rgba(0,200,100,0.3)" : "rgba(255,60,60,0.5)"}`,
              color: status === "cleared" ? "#4ade80" : "#f87171",
              cursor: status === "cleared" ? "not-allowed" : "pointer"
            },
            children: status === "cleared" ? "✓ CLEARED" : "CLEAR CACHE"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "gauge-wire", style: { opacity: 0.3 } }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
            ...
            className: "w-full py-3 rounded-xl font-mono font-bold text-sm uppercase tracking-widest transition-all",
            style: {
              background: "linear-gradient(135deg, rgba(150,0,200,0.2), rgba(200,0,150,0.1))",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "p",
          {
            ...
            children: "CLEAR & RELOAD will immediately refresh the page"
          }
        )
      ]
    }
...
function ChannelPanel({ channel, onClose }) {
  const cfg = CHANNEL_CONFIG[channel];
  const [enabled, setEnabled] = reactExports.useState(channel !== "bass");
  const [gain, setGain] = reactExports.useState(channel === "bass" ? 0 : 70);
  const toggle = (v2) => {
    setEnabled(v2);
    if (channel === "bass") engine.setBassEnabled(v2);
    else if (channel === "mids") engine.setMidsEnabled(v2);
    else if (channel === "highs") engine.setHighsEnabled(v2);
    else engine.setTweetersEnabled(v2);
  };
  const setG = (v2) => {
    setGain(v2);
    if (channel === "bass") engine.setBassGain(v2);
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    PanelShell,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-3 gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "slot-panel text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-foreground/50 font-mono", children: "FREQ" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-mono", style: { color: cfg.color }, children: cfg.freq })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "slot-panel text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-foreground/50 font-mono", children: "POWER" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-mono", style: { color: cfg.color }, children: cfg.watts })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "slot-panel text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-foreground/50 font-mono", children: "STATE" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                className: "text-sm font-mono",
                style: { color: enabled ? "#4ade80" : "#6b7280" },
                children: enabled ? "LIVE" : "MUTED"
              }
            )
          ] })
        ] }),
        ...
        channel === "bass" && /* @__PURE__ */ jsxRuntimeExports.jsx(
          AmpSlider,
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-foreground/40 text-center font-mono", children: "Dedicated channel · Own filter · Own gain · Zero shared nodes" })
      ]
    }
  );
}
function ChatBlockPanel({ onClose }) {
  const [confirmed, setConfirmed] = reactExports.useState(false);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    PanelShell,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-bold mb-2", style: { color: "#00d5ff" }, children: "Page-Level Chat Block" }),
              "Active detector that explicitly blocks any audio from playing on the chat page. Monitors page identity at the AudioContext level and terminates any audio connection that originates outside the app page. Music is private — app page only, always.",
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3 text-foreground/40", children: "Wiring: API · HTML · Chainblock · 4GA Wire" })
            ]
          }
        ),
        !confirmed ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          ...
          {
            type: "button",
            "data-ocid": "chat_block.activate_button",
            onClick: () => setConfirmed(true),
            className: "w-full py-3 rounded-xl font-mono font-bold text-sm uppercase tracking-widest transition-all",
            style: {
              background: "linear-gradient(135deg, rgba(0,100,255,0.2), rgba(255,180,0,0.1))",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            {
              type: "button",
              "data-ocid": "chat_block.confirm_button",
              disabled: true,
              className: "w-full py-3 rounded-xl font-mono font-bold text-sm uppercase tracking-widest opacity-40 cursor-not-allowed",
              style: {
                background: "rgba(0,50,120,0.3)",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            {
              type: "button",
              "data-ocid": "chat_block.cancel_button",
              onClick: () => setConfirmed(false),
              className: "w-full py-2 rounded-lg font-mono text-xs uppercase tracking-widest transition-all",
              style: {
                background: "rgba(0,20,50,0.4)",
...
function CheaterBeaterPanel({ onClose }) {
  const [enabled, setEnabled] = reactExports.useState(false);
  const [depth, setDepth] = reactExports.useState(0);
  const toggle = (v2) => {
    setEnabled(v2);
    engine.setCheaterBeater(v2, depth);
  };
  const setD = (v2) => {
    setDepth(v2);
    engine.setCheaterBeater(enabled, v2);
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    PanelShell,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "smd-meter text-center", children: enabled ? "33Hz SUB FOUNDATION — ACTIVE" : "14–50Hz STANDARD — ACTIVE" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          AmpToggle,
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "slot-panel", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs font-mono text-foreground/60", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
          "33Hz sub foundation · When ON, bass filter moves to 33Hz · Mutually exclusive"
        ] }) })
      ]
    }
  );
}
function ClassicalTrackPanel({ onClose }) {
  const [confirmed, setConfirmed] = reactExports.useState(false);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    PanelShell,
    {
      ...
      subtitle: "DIY KIT — LOCKED FEATURE",
      onClose,
      "data-ocid": "classical_track.panel",
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-bold mb-2", style: { color: "#00d5ff" }, children: "Classical Music Auto-Test" }),
              "Real classical music plays automatically through the full pipeline on startup, testing every engine and channel front to back and back to front. While it plays, the pipeline scans every node and reports any problem instantly. When all channels are green, the music stops and disconnects to free space.",
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3 text-foreground/40", children: "Wiring: API · HTML · Chainblock · 4GA Wire" })
            ]
          }
        ),
        !confirmed ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          ...
          {
            type: "button",
            "data-ocid": "classical_track.activate_button",
            onClick: () => setConfirmed(true),
            className: "w-full py-3 rounded-xl font-mono font-bold text-sm uppercase tracking-widest transition-all",
            style: {
              background: "linear-gradient(135deg, rgba(0,100,255,0.2), rgba(255,180,0,0.1))",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            {
              type: "button",
              "data-ocid": "classical_track.confirm_button",
              disabled: true,
              className: "w-full py-3 rounded-xl font-mono font-bold text-sm uppercase tracking-widest opacity-40 cursor-not-allowed",
              style: {
                background: "rgba(0,50,120,0.3)",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            {
              type: "button",
              "data-ocid": "classical_track.cancel_button",
              onClick: () => setConfirmed(false),
              className: "w-full py-2 rounded-lg font-mono text-xs uppercase tracking-widest transition-all",
              style: {
                background: "rgba(0,20,50,0.4)",
...
const logs = [];
function addCommanderLog(msg, level = "info") {
...
function CommanderPanel({ onClose }) {
  ...
  const [ctxState, setCtxState] = reactExports.useState("uninitialized");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    PanelShell,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-2", children: ["bass", "mids", "highs", "tweeters"].map((ch) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "slot-panel flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono text-foreground/70 uppercase", children: ch })
        ] }, ch)) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "slot-panel", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center mb-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono text-foreground/60", children: "ENGINE" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
                className: `text-xs font-mono ${ctxState === "running" ? "text-green-400" : "text-yellow-400"}`,
                children: ctxState.toUpperCase()
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono text-foreground/60", children: "CHAT PAGE" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono text-red-400", children: "BLOCKED — AUDIO APP ONLY" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "slot-panel", style: { maxHeight: 240, overflowY: "auto" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs font-mono text-foreground/50 mb-2", children: [
            "HISTORY (",
            logs.length,
            " entries)"
          ] }),
          history.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-mono text-foreground/30 text-center py-4", children: "No logs yet" }),
          history.map((log2) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 mb-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
                className: "text-xs font-mono",
                style: { color: "#4a5568", minWidth: 48 },
                children: new Date(log2.ts).toISOString().slice(11, 19)
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "span",
              {
                className: "text-xs font-mono",
                style: { color: levelColor[log2.level] },
                children: [
                  "[",
                  log2.level.toUpperCase(),
                  "]"
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono text-foreground/60 min-w-0 break-words", children: log2.msg })
          ] }, log2.ts))
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-foreground/40 text-center font-mono", children: "1000 entries · Auto-heal · Chat page — BLOCKED · API+HTML+CHAINBLOCK" })
      ]
    }
  );
}
function EQPanel({ onClose }) {
  const [bass, setBass] = reactExports.useState(0);
  const [lowmid, setLowmid] = reactExports.useState(0);
  const [vocals, setVocals] = reactExports.useState(0);
  const [mid, setMid] = reactExports.useState(0);
  const [highmid, setHighmid] = reactExports.useState(0);
  const [treble, setTreble] = reactExports.useState(0);
  const setB = (v2) => {
    setBass(v2);
    engine.setEQ("bass", v2);
  };
  const setLM = (v2) => {
    setLowmid(v2);
    engine.setEQ("lowmid", v2);
  };
  const setV = (v2) => {
    setVocals(v2);
    engine.setEQ("vocals", v2);
  };
  const setM = (v2) => {
    setMid(v2);
    engine.setEQ("mid", v2);
  ...
  const setHM = (v2) => {
    setHighmid(v2);
    engine.setEQ("highmid", v2);
  };
  const setT = (v2) => {
    setTreble(v2);
    engine.setEQ("treble", v2);
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    PanelShell,
    {
      ...
      "data-ocid": "eq.dialog",
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "smd-meter text-center", children: "6 BANDS · ±12dB · INDEPENDENT" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          AmpSlider,
          {
            label: "BASS 40Hz",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-foreground/40 text-center font-mono", children: "Each band independent · 50ms ramp · zero bleed" })
      ]
    }
  );
}
function EQuakePanel({ onClose }) {
  const [depth, setDepth] = reactExports.useState(0);
  const setD = (v2) => {
    setDepth(v2);
    engine.setEQuake(v2);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    PanelShell,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "smd-meter text-center", children: "EARTHQUAKE BASS · 20Hz · WIRED" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          AmpSlider,
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-foreground/40 text-center font-mono", children: "0 = off · 100 = full sub-quake · Real GainNode on bass channel" })
      ]
    }
  );
}
function EpicenterAutoPanel({ onClose }) {
  const [confirmed, setConfirmed] = reactExports.useState(false);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    PanelShell,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-bold mb-2", style: { color: "#00d5ff" }, children: "Automatic Epicenter Bass Note Response" }),
              "2–4 smart chips auto-detect and enhance 14–20Hz bass notes per song with no manual trigger. Early response smart chip eliminates dead zone at low frequencies. Foundation held at 14–50Hz on every note — never drops, never misses a hit.",
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3 text-foreground/40", children: "Wiring: API · HTML · Chainblock · 4GA Wire" })
            ]
          }
        ),
...
function EpicenterPanel({ onClose }) {
  const [enabled, setEnabled] = reactExports.useState(false);
  const [depth, setDepth] = reactExports.useState(0);
  const toggle = (v2) => {
    setEnabled(v2);
    engine.setEpicenter(v2, depth);
  };
  const setD = (v2) => {
    setDepth(v2);
    engine.setEpicenter(enabled, v2);
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    PanelShell,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "smd-meter text-center", children: "BASS EPICENTER · 32Hz PEAKING · AUTO" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          AmpToggle,
          {
            label: "Epicenter",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-foreground/40 text-center font-mono", children: "Holds bass foundation on every note" })
      ]
    }
  );
}
function FreqMatchPanel({ onClose }) {
  const [confirmed, setConfirmed] = reactExports.useState(false);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    PanelShell,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-bold mb-2", style: { color: "#00d5ff" }, children: "Automatic Frequency Matching" }),
              "10 bass profiles and 10 high note profiles. Smart chips auto-select the best profile for each song. Multi-Frequency Hit System locks 3–4 dominant frequencies per layer — bass, mids, highs — and switches in real time as the song plays.",
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3 text-foreground/40", children: "Wiring: API · HTML · Chainblock · 4GA Wire" })
            ]
          }
        ),
...
function MasterGainPanel({ onClose }) {
  const [gain, setGain] = reactExports.useState(70);
  const setG = (v2) => {
    setGain(v2);
    engine.setMasterGain(v2);
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    PanelShell,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "smd-meter text-center", children: "FINAL STAGE · BEFORE DESTINATION" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          AmpSlider,
          {
            label: "MASTER GAIN",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "slot-panel", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono text-foreground/70", children: "CHAIN POSITION" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono text-blue-400", children: "systemBooster → masterGain → destination" })
        ] }) })
      ]
    }
  );
}
function NaturalBottomPanel({ onClose }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    PanelShell,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "smd-meter text-center", children: "ALWAYS ON · NEVER A TOGGLE · +2dB SHELF" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "slot-panel flex flex-col gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono text-foreground/70", children: "FREQUENCY" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono text-orange-400", children: "60Hz" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono text-foreground/70", children: "TYPE" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono text-orange-400", children: "Low Shelf" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono text-foreground/70", children: "GAIN" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono text-green-400", children: "+2dB (fixed)" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono text-foreground/70", children: "STATE" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono text-green-400", children: "✓ ALWAYS ACTIVE" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs text-foreground/40 text-center font-mono", children: [
...
function ProtectionPanel({ onClose }) {
  const [enabled, setEnabled] = reactExports.useState(true);
  const [distortion, setDistortion] = reactExports.useState(50);
  const [clipping, setClipping] = reactExports.useState(50);
  const [particle, setParticle] = reactExports.useState(50);
  const toggle = (v2) => {
    setEnabled(v2);
    engine.setProtectionEnabled(v2);
  };
  const setD = (v2) => {
    setDistortion(v2);
    engine.setDistortionClean(v2);
  };
  const setC = (v2) => {
    setClipping(v2);
    engine.setClippingControl(v2);
  };
  const setP = (v2) => {
    setParticle(v2);
    engine.setParticleBreakdown(v2);
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    PanelShell,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "smd-meter text-center", children: enabled ? "✅ ACTIVE — SIGNAL PROTECTED" : "⚠️ BYPASSED — RAW SIGNAL" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          AmpToggle,
          {
            label: "Protection",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-foreground/40 text-center font-mono", children: "Tough by default · Never chokes volume · No hard limiter" })
      ]
    }
  );
}
function SRSPanel({ onClose }) {
  const [enabled, setEnabled] = reactExports.useState(false);
  const [wet, setWet] = reactExports.useState(30);
  const toggle = (v2) => {
    setEnabled(v2);
    engine.setSRS(v2, wet);
  };
  const setW = (v2) => {
    setWet(v2);
    engine.setSRS(enabled, v2);
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    PanelShell,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "smd-meter text-center", children: "SRS HD 9.0 · CONVOLVER · ROOM IR" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          AmpToggle,
          {
            label: "SRS HD 9.0",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "slot-panel", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-mono text-foreground/60", children: "SNR >110dB · THD <0.01% · Smooth tweeters · Sound projects outside speaker" }) })
      ]
    }
  );
}
function Scanner99Panel({ onClose }) {
      ...
      r.length > 0 ? r : [
        {
          ...
          status: "ok",
          detail: "No silence causes found. Chain is clean. Try tapping Start and loading a track."
        }
      ]
    );
    setScanning(false);
  };
  const allGreen = results.length > 0 && results.every((r) => r.status === "ok");
  const errCount = results.filter((r) => r.status === "error").length;
  const warnCount = results.filter((r) => r.status === "warn").length;
  const statusColor = (s) => s === "ok" ? "#4ade80" : s === "warn" ? "#fbbf24" : "#f87171";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    PanelShell,
    {
      title: "99.0 SCANNER",
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              children: scanning ? "SCANNING…" : "RUN FULL SCAN"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
        ...
        results.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "smd-meter text-center", children: allGreen ? "✅ ALL GREEN — CHAIN CLEAN" : `⚠️ ${errCount} ERROR${errCount !== 1 ? "S" : ""} · ${warnCount} WARNING${warnCount !== 1 ? "S" : ""}` }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: "flex flex-col gap-1",
              style: { maxHeight: 320, overflowY: "auto" },
              children: results.map((r) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-mono text-foreground/50 break-words", children: r.detail })
                    ] })
                  ]
                },
                r.id
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-foreground/40 text-center font-mono", children: "Runs 20 checks against live audio nodes · Database memory · Auto-fix" })
      ]
    }
  );
}
function SoulModePanel({ onClose }) {
  const [enabled, setEnabled] = reactExports.useState(false);
  const [depth, setDepth] = reactExports.useState(0);
  const toggle = (v2) => {
    setEnabled(v2);
    engine.setSoulMode(v2, depth);
  };
  const setD = (v2) => {
    setDepth(v2);
    engine.setSoulMode(enabled, v2);
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    PanelShell,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "smd-meter text-center", children: "MIDS RESONANCE · 300Hz PEAKING · SOUL" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          AmpToggle,
          {
            label: "Soul Mode",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-foreground/40 text-center font-mono", children: "Preserves harmonics in mids · Always has soul even without bass" })
      ]
    }
  );
}
function SoundBeamingPanel({ onClose }) {
  const [enabled, setEnabled] = reactExports.useState(false);
  const [intensity, setIntensity] = reactExports.useState(50);
  const toggle = (v2) => {
    setEnabled(v2);
    engine.setSoundBeaming(v2, intensity);
  };
  const setI = (v2) => {
    setIntensity(v2);
    engine.setSoundBeaming(enabled, v2);
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    PanelShell,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "smd-meter text-center", children: "L / R / FRONT / REAR · HRTF BEAM · ADDITIVE" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          AmpToggle,
          {
            label: "Sound Beaming",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "slot-panel", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs font-mono text-foreground/60", children: [
          "⚡ ADDITIVE TAP: channelMerger → 4 PannerNodes → beamMergeGain → destination",
          /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
          "Never intercepts main signal path · beamMergeGain is permanent class property"
        ] }) })
      ]
    }
  );
}
function SystemBoosterPanel({ onClose }) {
  const [enabled, setEnabled] = reactExports.useState(false);
  const toggle = (v2) => {
    setEnabled(v2);
    engine.setSystemBooster(v2);
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    PanelShell,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "smd-meter text-center", children: enabled ? "×1.380 BOOST — ACTIVE" : "×1.0 UNITY — BYPASSED" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          AmpToggle,
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "slot-panel flex flex-col gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono text-foreground/70", children: "BOOST FACTOR" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono text-green-400", children: enabled ? "×1.380" : "×1.0 (unity)" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono text-foreground/70", children: "POWER SOURCE" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono text-blue-400", children: "ISOLATED · OWN POWER" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono text-foreground/70", children: "DRAWS FROM CHAIN" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono text-green-400", children: "NEVER" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-foreground/40 text-center font-mono", children: "Self-contained · Never draws from main power chain" })
      ]
    }
  );
}
...
function TitaniumFusePanel({ onClose }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    PanelShell,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "smd-meter text-center", children: "50W · 4GA WIRE · 5,000×20 · MONITOR ONLY" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "slot-panel", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-mono text-foreground/70 mb-2", children: "SIGNAL LEVEL MONITOR" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-0.5 h-6", children: BAR_IDS.map((id, barPos) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: "flex-1 rounded-sm transition-all",
              style: {
                background: barPos < bars ? barPos > 16 ? "#ef4444" : barPos > 12 ? "#f59e0b" : "#4ade80" : "rgba(255,255,255,0.05)"
              }
            },
            id
          )) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs font-mono text-foreground/50 mt-1 text-center", children: [
            (level * 100).toFixed(1),
            "%"
          ] })
        ] }),
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-mono text-foreground/50 truncate", children: row.detail })
        ] }),
        row.powerWatts > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "span",
          {
            className: "text-xs font-mono flex-shrink-0",
            style: { color: "rgba(0,213,255,0.6)" },
            children: [
              (row.powerWatts / 1e3).toFixed(0),
              "kW"
            ]
          }
        )
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: "text-xs font-mono",
              style: {
                color: r.status === "fail" ? "#ef4444" : r.status === "warn" ? "#fbbf24" : "rgba(255,255,255,0.75)"
              },
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: { color: "rgba(0,213,255,0.7)" }, children: [
                  "[",
                  r.engine,
                  "]"
                ] }),
                " ",
                r.node,
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-2 text-foreground/40", children: r.detail })
              ]
            }
          ),
          r.autoFixed && r.fixDescription && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
...
function TrackTesterPanel({
  ...
  const [engineRows, setEngineRows] = reactExports.useState([]);
  const [filter, setFilter] = reactExports.useState("all");
  const scanRef = reactExports.useRef(false);
  const refreshEngineStatuses = reactExports.useCallback(() => {
  ...
  const filteredResults = (result == null ? void 0 : result.results.filter((r) => {
      ...
      children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "span",
                {
                  ...
                  children: [
                    ...
                    phase === "done" && (passed ? "ALL GREEN — CHAIN CONFIRMED" : `${result == null ? void 0 : result.failedCount} ISSUES FOUND`)
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-auto text-xs font-mono text-foreground/30", children: "API · HTML · CHAINBLOCK · 4GA" })
            ]
          }
        ),
        phase === "scanning" && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
        ...
        result && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              result.summary,
              result.autoFixedCount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "ml-2", style: { color: "#60a5fa" }, children: [
                "· ",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-mono text-foreground/40 uppercase tracking-wider mb-1.5 px-1", children: "Engine Status" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-1.5", children: engineRows.map((row) => /* @__PURE__ */ jsxRuntimeExports.jsx(EngineBadge, { row }, row.engine)) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-3 px-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono text-foreground/40", children: "DIRECTION:" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono", style: { color: "#00d5ff" }, children: "FORWARD →" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono text-foreground/30", children: "|" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono", style: { color: "#a78bfa" }, children: "← BACKWARD" })
        ] }),
        result && result.results.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1.5 mb-2", children: ["all", "forward", "backward"].map((f) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
            ...
            style: {
              background: filter === f ? "rgba(0,100,255,0.3)" : "rgba(0,30,80,0.3)",
              border: `1px solid ${filter === f ? "rgba(0,150,255,0.6)" : "rgba(0,100,255,0.2)"}`,
              color: filter === f ? "#00d5ff" : "rgba(255,255,255,0.4)"
            },
            children: f === "all" ? `All (${result.results.length})` : f === "forward" ? `→ Fwd (${result.results.filter((r) => r.direction === "forward").length})` : `← Back (${result.results.filter((r) => r.direction === "backward").length})`
          },
          f
        )) }),
        filteredResults.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: filteredResults.map((r, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              ResultRow,
              {
                r,
                idx: i
              },
              `${r.engine}-${r.node}-${r.direction}-${i}`
            ))
          }
        ),
        phase === "idle" && filteredResults.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-6", "data-ocid": "track_tester.empty_state", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl mb-2", children: "⚡" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-mono text-foreground/40", children: "Tap RUN SCAN to test the full pipeline" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-mono text-foreground/30 mt-1", children: "Front → back AND back ← front bidirectional scan" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            style: {
              background: phase === "scanning" ? "rgba(0,50,100,0.3)" : "linear-gradient(135deg, rgba(0,100,255,0.25), rgba(0,213,255,0.15))",
              border: `1px solid ${phase === "scanning" ? "rgba(0,100,255,0.2)" : "rgba(0,213,255,0.5)"}`,
              color: phase === "scanning" ? "rgba(0,213,255,0.4)" : "#00d5ff",
              textShadow: phase === "scanning" ? "none" : "0 0 8px rgba(0,213,255,0.6)",
              cursor: phase === "scanning" ? "not-allowed" : "pointer"
            },
            children: phase === "scanning" ? "SCANNING…" : "RUN SCAN"
          }
        )
      ]
    }
...
function UltraCrystalPanel({ onClose }) {
  const [confirmed, setConfirmed] = reactExports.useState(false);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    PanelShell,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-bold mb-2", style: { color: "#00d5ff" }, children: "Ultra Crystal Clear Engine" }),
              "Dedicated clarity processor for highs and vocals. Commander protection ensures zero harshness and zero distortion at full power. Virtual magnet for maximum clarity locks the signal path so instruments are raised to the highest class with zero background noise.",
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3 text-foreground/40", children: "Wiring: API · HTML · Chainblock · 4GA Wire" })
            ]
          }
        ),
        !confirmed ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          ...
          {
            type: "button",
            "data-ocid": "ultra_crystal.activate_button",
            onClick: () => setConfirmed(true),
            className: "w-full py-3 rounded-xl font-mono font-bold text-sm uppercase tracking-widest transition-all",
            style: {
              background: "linear-gradient(135deg, rgba(0,100,255,0.2), rgba(255,180,0,0.1))",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            {
              type: "button",
              "data-ocid": "ultra_crystal.confirm_button",
              disabled: true,
              className: "w-full py-3 rounded-xl font-mono font-bold text-sm uppercase tracking-widest opacity-40 cursor-not-allowed",
              style: {
                background: "rgba(0,50,120,0.3)",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            {
              type: "button",
              "data-ocid": "ultra_crystal.cancel_button",
              onClick: () => setConfirmed(false),
              className: "w-full py-2 rounded-lg font-mono text-xs uppercase tracking-widest transition-all",
              style: {
                background: "rgba(0,20,50,0.4)",
...
function VirtualMagnetPanel({ onClose }) {
  const [enabled, setEnabled] = reactExports.useState(false);
  const [depth, setDepth] = reactExports.useState(0);
  const toggle = (v2) => {
    setEnabled(v2);
    engine.setVirtualMagnet(v2, depth);
  };
  const setD = (v2) => {
    setDepth(v2);
    engine.setVirtualMagnet(enabled, v2);
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    PanelShell,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "smd-meter text-center", children: "0.5Hz LFO · BASS ONLY · NO DESTINATION" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          AmpToggle,
          {
...
function XMProcessorPanel({ onClose }) {
  const [enabled, setEnabled] = reactExports.useState(false);
  const [gain, setGain] = reactExports.useState(0);
  const toggle = (v2) => {
    setEnabled(v2);
    engine.setXM(v2, gain);
  };
  const setG = (v2) => {
    setGain(v2);
    engine.setXM(enabled, v2);
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    PanelShell,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "smd-meter text-center", children: "XM PROCESSOR · 24dB/OCT · OWN POWER" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          AmpToggle,
          {
            label: "XM Processor",
...
function DigitalClock() {
  ...
  reactExports.useEffect(() => {
    ...
    update();
    const id = setInterval(update, 1e4);
    return () => clearInterval(id);
  }, []);
  return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hu-clock", children: time });
}
function Marquee({ text }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-hidden flex-1 min-w-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      style: {
        ...
        animation: text.length > 22 ? "marquee-scroll 10s linear infinite" : void 0
      },
      children: text
    }
  ) });
...
function HUTile({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
      ...
      children: [
        tile.locked && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hu-tile-lock-badge", children: "🔒" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hu-tile-icon", style: { color: tile.color }, children: tile.icon }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hu-tile-info", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hu-tile-label", children: tile.label }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hu-tile-sub", children: tile.sub }),
          isActive && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hu-tile-active-bar" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(LED, { active: isActive, color: tile.color })
      ]
    }
  );
}
function CinematicCredits({ onClose }) {
  reactExports.useEffect(() => {
    ...
    let index2 = 0;
    const speakNext = () => {
      if (index2 >= lines.length) return;
      const utterance = new SpeechSynthesisUtterance(lines[index2]);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-hidden relative flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "animate-credits-scroll credits-scroll-container", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-6xl text-center", children: "⚡" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "h1",
            {
              className: "text-2xl font-mono font-bold text-glow text-center",
              style: { color: "#00d5ff" },
              children: "POWERAMP PLAYER"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "credits-line font-mono text-foreground/60", children: "Engineered by Gerrod" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "gauge-wire active w-32 mx-auto" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "credits-line font-mono text-foreground/80", children: "12-Layer Power Chain · 960,000W Total" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "credits-line font-mono text-foreground/60", children: "Bass · Mids · Highs · Tweeters" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "credits-line font-mono text-foreground/60", children: "Epicenter · Cheater Beater · E-Quake" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "credits-line font-mono text-foreground/60", children: "Atmosmashere · SRS HD 9.0 · XM Processor" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "credits-line font-mono text-foreground/60", children: "Sound Beaming · Virtual Magnet · System Booster" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "credits-line font-mono text-foreground/60", children: "Master Commander · 99.0 Scanner" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "gauge-wire active w-32 mx-auto" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "credits-line font-mono text-foreground/40 text-xs", children: "4 Gauge Wire · API · HTML · Chainblock" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "credits-line font-mono text-foreground/40 text-xs", children: "Audio plays on app page only" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "credits-line font-mono text-foreground/40 text-xs", children: "Every feature truly wired to the signal chain" })
        ] }) })
      ]
    }
  );
...
function PlayerPage() {
  ...
  const [trackName, setTrackName] = reactExports.useState("NO TRACK LOADED");
  const [frontlineVol, setFrontlineVol] = reactExports.useState(490);
  const [activePanel, setActivePanel] = reactExports.useState(null);
  const [showCredits, setShowCredits] = reactExports.useState(false);
  const [activeTiles, setActiveTiles] = reactExports.useState(/* @__PURE__ */ new Set());
  ...
  const handleVolume = reactExports.useCallback((e) => {
    const v2 = Number(e.target.value);
    setFrontlineVol(v2);
    engine.setFrontlineVol(v2);
  }, []);
  const handleVolUp = reactExports.useCallback(() => {
    const v2 = Math.min(700, frontlineVol + 20);
    setFrontlineVol(v2);
    engine.setFrontlineVol(v2);
  }, [frontlineVol]);
  const handleVolDown = reactExports.useCallback(() => {
    const v2 = Math.max(1, frontlineVol - 20);
    setFrontlineVol(v2);
    engine.setFrontlineVol(v2);
  }, [frontlineVol]);
  ...
  const openPanel = reactExports.useCallback((id) => {
    setActivePanel(id);
    setActiveTiles((prev) => {
      const n = new Set(prev);
      n.add(id);
  ...
  const closePanel = reactExports.useCallback(() => setActivePanel(null), []);
  if (!started) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "start-logo", children: "⚡" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-mono text-foreground/50 mt-1", children: "Engineered by Gerrod · 4 Gauge Wire · API · HTML · Chainblock" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              disabled: starting,
              className: "start-btn",
              children: starting ? "STARTING…" : "TAP TO START"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-mono text-foreground/30 text-center max-w-xs", children: "Tap to unlock the audio engine · Audio plays on this page only" })
        ]
      }
    );
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hu-control-strip", "data-ocid": "player.control_strip", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hu-strip-logo", children: "⚡" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hu-strip-divider" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              type: "button",
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hu-strip-icon", children: "+" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hu-strip-label", children: "VOL" })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hu-strip-icon", children: muted ? "🔇" : "🔊" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hu-strip-label", children: muted ? "MUTE" : "SND" })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hu-strip-divider" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hu-strip-icon", children: "🎛" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hu-strip-label", children: "EQ" })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hu-strip-icon", children: "★" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hu-strip-label", children: "STORY" })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hu-strip-spacer" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: "hu-strip-status-dot",
              style: {
                background: engine.getContextState() === "running" ? "#4ade80" : "#fbbf24",
                boxShadow: engine.getContextState() === "running" ? "0 0 6px #4ade80" : "0 0 6px #fbbf24"
              }
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hu-main", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hu-vol-bar", "data-ocid": "player.vol_bar", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                ref: fileRef,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hu-vol-bar-center", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hu-vol-bar-label", children: "FRONTLINE VOLUME" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "input",
                {
                  type: "range",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hu-vol-bar-val", children: frontlineVol })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hu-topbar", "data-ocid": "player.transport_bar", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hu-topbar-title", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hu-topbar-brand", children: "POWERAMP" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hu-topbar-sub", children: "by Gerrod" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(DigitalClock, {})
          ] }),
          testStatus !== "" && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: "test-banner",
              "data-ocid": "track_tester.status_banner",
              style: {
                background: testStatus === "running" ? "rgba(0,80,200,0.2)" : testStatus === "passed" ? "rgba(0,120,60,0.25)" : "rgba(180,30,30,0.25)",
                borderBottomColor: testStatus === "running" ? "rgba(0,150,255,0.3)" : testStatus === "passed" ? "rgba(0,200,100,0.4)" : "rgba(255,80,80,0.4)"
              },
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "span",
                {
                  className: "text-xs font-mono",
                  style: {
                    color: testStatus === "running" ? "#60a5fa" : testStatus === "passed" ? "#4ade80" : "#fca5a5"
                  },
                  children: [
                    testStatus === "running" && "⟳ Running track test through full pipeline…",
                    testStatus === "passed" && "✓ Chain confirmed — all engines ready",
                    testStatus === "failed" && "⚠ Issues found — opening Track Tester"
                  ]
                }
              )
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hu-grid-scroll", "data-ocid": "player.tile_grid", children: [
            "channel",
            "eq",
            "bass",
            "spatial",
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hu-group", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hu-group-header", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: GROUP_LABELS[group] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hu-group-line" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hu-player-bar", "data-ocid": "player.bottom_bar", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hu-track-display", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hu-track-label", children: "TRACK" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Marquee, { text: trackName })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                style: {
                  color: engine.getContextState() === "running" ? "#4ade80" : "#fbbf24",
                  textShadow: engine.getContextState() === "running" ? "0 0 6px #4ade80" : "0 0 6px #fbbf24"
                },
                children: [
                  "ENGINE ",
                  engine.getContextState().toUpperCase()
                ]
              }
            )
          ] })
        ] }),
        activePanel === "bass" && /* @__PURE__ */ jsxRuntimeExports.jsx(ChannelPanel, { channel: "bass", onClose: closePanel }),
        activePanel === "mids" && /* @__PURE__ */ jsxRuntimeExports.jsx(ChannelPanel, { channel: "mids", onClose: closePanel }),
        activePanel === "highs" && /* @__PURE__ */ jsxRuntimeExports.jsx(ChannelPanel, { channel: "highs", onClose: closePanel }),
        activePanel === "tweeters" && /* @__PURE__ */ jsxRuntimeExports.jsx(ChannelPanel, { channel: "tweeters", onClose: closePanel }),
        activePanel === "eq" && /* @__PURE__ */ jsxRuntimeExports.jsx(EQPanel, { onClose: closePanel }),
        activePanel === "protection" && /* @__PURE__ */ jsxRuntimeExports.jsx(ProtectionPanel, { onClose: closePanel }),
        activePanel === "epicenter" && /* @__PURE__ */ jsxRuntimeExports.jsx(EpicenterPanel, { onClose: closePanel }),
        activePanel === "cheaterbeater" && /* @__PURE__ */ jsxRuntimeExports.jsx(CheaterBeaterPanel, { onClose: closePanel }),
        activePanel === "equake" && /* @__PURE__ */ jsxRuntimeExports.jsx(EQuakePanel, { onClose: closePanel }),
        activePanel === "naturalbottom" && /* @__PURE__ */ jsxRuntimeExports.jsx(NaturalBottomPanel, { onClose: closePanel }),
        activePanel === "soulmode" && /* @__PURE__ */ jsxRuntimeExports.jsx(SoulModePanel, { onClose: closePanel }),
        activePanel === "atmosmashere" && /* @__PURE__ */ jsxRuntimeExports.jsx(AtmosmasherePanel, { onClose: closePanel }),
        activePanel === "srs" && /* @__PURE__ */ jsxRuntimeExports.jsx(SRSPanel, { onClose: closePanel }),
        activePanel === "xmprocessor" && /* @__PURE__ */ jsxRuntimeExports.jsx(XMProcessorPanel, { onClose: closePanel }),
        activePanel === "soundbeaming" && /* @__PURE__ */ jsxRuntimeExports.jsx(SoundBeamingPanel, { onClose: closePanel }),
        activePanel === "virtualmagnet" && /* @__PURE__ */ jsxRuntimeExports.jsx(VirtualMagnetPanel, { onClose: closePanel }),
        activePanel === "systembooster" && /* @__PURE__ */ jsxRuntimeExports.jsx(SystemBoosterPanel, { onClose: closePanel }),
        activePanel === "titaniumfuse" && /* @__PURE__ */ jsxRuntimeExports.jsx(TitaniumFusePanel, { onClose: closePanel }),
        activePanel === "commander" && /* @__PURE__ */ jsxRuntimeExports.jsx(CommanderPanel, { onClose: closePanel }),
        activePanel === "scanner99" && /* @__PURE__ */ jsxRuntimeExports.jsx(Scanner99Panel, { onClose: closePanel }),
        activePanel === "mastergain" && /* @__PURE__ */ jsxRuntimeExports.jsx(MasterGainPanel, { onClose: closePanel }),
        activePanel === "trackTester" && /* @__PURE__ */ jsxRuntimeExports.jsx(TrackTesterPanel, { onClose: closePanel }),
        activePanel === "classicalTrack" && /* @__PURE__ */ jsxRuntimeExports.jsx(ClassicalTrackPanel, { onClose: closePanel }),
        activePanel === "bassSwitch" && /* @__PURE__ */ jsxRuntimeExports.jsx(BassSwitchPanel, { onClose: closePanel }),
        activePanel === "epicenterAuto" && /* @__PURE__ */ jsxRuntimeExports.jsx(EpicenterAutoPanel, { onClose: closePanel }),
        activePanel === "freqMatch" && /* @__PURE__ */ jsxRuntimeExports.jsx(FreqMatchPanel, { onClose: closePanel }),
        activePanel === "ultraCrystal" && /* @__PURE__ */ jsxRuntimeExports.jsx(UltraCrystalPanel, { onClose: closePanel }),
        activePanel === "audioBuffer" && /* @__PURE__ */ jsxRuntimeExports.jsx(AudioBufferPanel, { onClose: closePanel }),
        activePanel === "chatBlock" && /* @__PURE__ */ jsxRuntimeExports.jsx(ChatBlockPanel, { onClose: closePanel }),
        activePanel === "cache" && /* @__PURE__ */ jsxRuntimeExports.jsx(CachePanel, { onClose: closePanel }),
        showCredits && /* @__PURE__ */ jsxRuntimeExports.jsx(CinematicCredits, { onClose: () => setShowCredits(false) })
      ]
    }
  );
}
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 14 }, children: "PowerAmp Player — Engine Error" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                style: {
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ErrorBoundary, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(QueryClientProvider, { client: queryClient$1, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-full dark", children: /* @__PURE__ */ jsxRuntimeExports.jsx(PlayerPage, {}) }),
