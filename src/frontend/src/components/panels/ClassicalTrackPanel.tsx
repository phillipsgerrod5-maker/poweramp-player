/**
 * ClassicalTrackPanel — DIY KIT LOCKED
 * Classical Music Auto-Test feature placeholder.
 * Not yet wired to audio chain — activates when user is ready.
 */
import { useState } from "react";
import { PanelShell } from "./PanelShell";

export function ClassicalTrackPanel({ onClose }: { onClose: () => void }) {
    ...
    >
      ...
      >
        <div className="font-bold mb-2" style={{ color: "#00d5ff" }}>
          Classical Music Auto-Test
        </div>
        Real classical music plays automatically through the full pipeline on
        startup, testing every engine and channel front to back and back to
        front. While it plays, the pipeline scans every node and reports any
        problem instantly. When all channels are green, the music stops and
        disconnects to free space.
