/**
 * ChatBlockPanel — DIY KIT LOCKED
 * Page-Level Chat Block feature placeholder.
 */
import { useState } from "react";
import { PanelShell } from "./PanelShell";

export function ChatBlockPanel({ onClose }: { onClose: () => void }) {
    ...
    >
      ...
      >
        <div className="font-bold mb-2" style={{ color: "#00d5ff" }}>
          Page-Level Chat Block
        </div>
        Active detector that explicitly blocks any audio from playing on the
        chat page. Monitors page identity at the AudioContext level and
        terminates any audio connection that originates outside the app page.
        Music is private — app page only, always.
